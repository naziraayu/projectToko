      ...
      <script>
                        ...
                        <script>
                            function prosespesanan() {
                                <?php
                                    ...
                                    if ($result) {
                                        ?>
                                        window.location.href="ajuanBatal.php?proses=<?php echo $no1;?>";
                                        <?php
                                    }
                                ?>
                        ...
                        <script>
                            function tolakpesanan() {
                                <?php
                                    ...
                                    if ($result) {
                                        ?>
                                        window.location.href="ajuanBatal.php?tolak=<?php echo $noo;?>";
                                        <?php
                                    }
                                ?>
                            }
        ...
        <?php
            if (isset($_GET['tolak'])) {
                ...
                ?>
                <script>
                    alert("Berhasil menolak ajuan pembatalan");
            ...
            if (isset($_GET['proses'])) {
                ...
                ?>
                <script>
                    alert("Berhasil memproses ajuan pembatalan");
                    window.location.href="ajuanBatal.php";
                </script>
                <?php
            }
