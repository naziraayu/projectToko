...
<body>
    <form action="pesananBaru1.php" method="post">
    <header>
        <div class="head">
            <div class="nav">
      ...
      <script>
                    ...
                    <thead>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button><a href="pesananBaru1.php?tampil=<?php echo $noNota; ?>"><i class="fa-solid fa-arrow-right"></i></a></button>
                                </td>
                            </tr>
                            <?php
                            }
                            ...
                            <script>
                                function prosespesanan() {
                                    <?php
                                        ...
                                        if ($result) {
                                            ?>
                                                window.location.href="pesananBaru1.php?proses=<?php echo $no1;?>";
                                            <?php
                                        }
                                    ?>
                                }
                                function tolakpesanan() {
                                    <?php
                                        ...
                                        if ($result) {
                                            ?>
                                            window.location.href="pesananBaru1.php?tolak=<?php echo $noo;?>";
                                            <?php
                                        }
                                    ?>
                                }
        ...
        if (isset($_GET['tolak'])) {
            $no=$_GET['tolak'];
            $query="UPDATE status_transaksi set status='pesanan dibatalkan' where no_nota='$no'";
            $result=mysqli_query($koneksi, $query);
            ?>
            <script>
                alert("Pesanan berhasil ditolak");
                window.location.href="pesananBaru1.php";
            </script>
            <?php
        }
