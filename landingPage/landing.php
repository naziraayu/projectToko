...
<body>
    ...
    <div class="header" id="home">    
        ...
        <div class="title">
            <img data-aos="fade-right" data-aos-duration="1000" src="../img/judul.png" alt="">
        </div>
        <div class="deskripsi">
            <span  ><p data-aos="fade-right" data-aos-duration="1200">Toko Spesialis Kue Basah</p></span>
            <span ><p data-aos="fade-right" data-aos-duration="1200">Terbesar di Jember</p></span>
        </div>
        <div class="content">
            <div data-aos="fade-up" data-aos-duration="1000" class="first-card">
                <div class="image">
            ...
            <div data-aos="fade-up" data-aos-duration="1200" class="second-card">
                <div class="image">
    ...
    <div class="wrapper" id="best_seller">
        ...
        <div class="menu">
            <div class="first-menu"> 
                <div data-aos="fade-up" data-aos-duration="1200" class="card-menu">
                ...
                <div data-aos="fade-up" data-aos-duration="1400"class="card-menu">
                    <div class="image-menu">
                ...
                <div data-aos="fade-up" data-aos-duration="1600"class="card-menu">
    ...
    <div class="wrap-content" id="produk">
        ...
        <div data-aos="fade-up" data-aos-duration="1600" class="product-content"> 
            <div class="product">
    ...
    <div data-aos="fade-up" data-aos-duration="1600" class="maps" id="maps">
        <div class="image">
    ...
    <div class="info-contact" id="info">
        <div class="contact">
            <img src="../img/back-info.png" alt="">
            <div class="info">
                <div data-aos="fade-up" data-aos-duration="1200" class="card-info">
                    <h3>Alamat</h3>
                    <img src="../img/alamat.png" alt="">
                    <p>Jln. Bengawan Solo, <br> Jember, Jawa Timur</p>
                </div>
                <div data-aos="fade-up" data-aos-duration="1400" class="card-info">
                    <h3>Jam Kerja</h3>
                    <img src="../img/jam.png" alt="">
                    <p>Senin-Sabtu <br> 05:00 s/d 19:00</p>
                </div>
                <div data-aos="fade-up" data-aos-duration="1600" class="card-info">
                    <h3>Telepon</h3>
